...
struct __CFRunLoop {
  ...
  uint32_t _winthread;
  CFMutableSetRef _commonModes;     // concrete mode names contained in kCFRunLoopCommonModes runloop mode.
  CFMutableSetRef _commonModeItems; // contains items of type CFRunLoopSourceRef, CFRunLoopObserverRef,
                                    // or CFRunLoopTimerRef added to kCFRunLoopCommonModes runloop mode.
...
#if TARGET_OS_MAC
static Boolean __CFRunLoopDoSource1(CFRunLoopRef rl, 
                                    CFRunLoopModeRef rlm,
                                    CFRunLoopSourceRef rls,
                                    mach_msg_header_t *msg,
                                    CFIndex size,
                                    mach_msg_header_t **reply) __attribute__((noinline));
...
CFRunLoopTimerRef CFRunLoopTimerCreateWithHandler(CFAllocatorRef allocator, 
                                                  CFAbsoluteTime fireDate,
                                                  CFTimeInterval interval,
                                                  CFOptionFlags flags,
                                                  CFIndex order,
